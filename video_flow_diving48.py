...
def video_flow(args):
    ...
    all_videos = sorted(sample(all_videos,50))
    ...
    with torch.no_grad():
        ...
        for i, video_fname in enumerate(all_videos):
            ...
            for image1, image2 in zip(rgb_frames[:-1], rgb_frames[1:]):
                ...
                #viz(image1_proc, image2_proc, flow_up_pad)
            ...
            print(i, video_fname, (end-start), len(rgb_frames))
        df.to_csv(os.path.join(args.output_path, 'video_has_flow.csv'))
